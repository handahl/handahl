...
`Linux` · `Podman/Quadlet` · `systemd` · `Fedora Atomic / uCore` · `bootc/OCI` · `Kanidm` · `Traefik` · `SELinux` · `cosign` · `Go` · `Bash` · `Self-hosting` · `Surveillance Studies` · `neuodivergent` · `deviance` · `anthropology as code` · `code as anthropology`
